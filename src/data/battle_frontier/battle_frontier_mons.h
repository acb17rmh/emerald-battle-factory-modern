...
const struct TrainerMon gBattleFrontierMons[NUM_FRONTIER_MONS] =
{
    ...
    FRONTIER_MODERN_SET(FRONTIER_MON_GENERATED_ALOMOMOLA_1, SPECIES_ALOMOMOLA, ABILITY_HEALER, ITEM_ASSAULT_VEST, NATURE_SASSY, 252, 0, 4, 0, 252, 0, MOVE_FLIP_TURN, MOVE_MIRROR_COAT, MOVE_SCALD, MOVE_BODY_SLAM),
    FRONTIER_MODERN_SET(FRONTIER_MON_GENERATED_ALOMOMOLA_2, SPECIES_ALOMOMOLA, ABILITY_HEALER, ITEM_HEAVY_DUTY_BOOTS, NATURE_RELAXED, 252, 0, 252, 0, 4, 0, MOVE_FLIP_TURN, MOVE_WISH, MOVE_PROTECT, MOVE_SCALD),
    ...
    FRONTIER_MODERN_SET(FRONTIER_MON_GENERATED_ALOMOMOLA_3, SPECIES_ALOMOMOLA, ABILITY_HEALER, ITEM_ROCKY_HELMET, NATURE_RELAXED, 252, 0, 252, 0, 4, 0, MOVE_PLAY_ROUGH, MOVE_WHIRLPOOL, MOVE_WISH, MOVE_PROTECT),
    FRONTIER_MODERN_SET(FRONTIER_MON_GENERATED_ALOMOMOLA_4, SPECIES_ALOMOMOLA, ABILITY_HEALER, ITEM_HEAVY_DUTY_BOOTS, NATURE_BOLD, 252, 0, 252, 0, 4, 0, MOVE_WISH, MOVE_PROTECT, MOVE_FLIP_TURN, MOVE_SCALD),
